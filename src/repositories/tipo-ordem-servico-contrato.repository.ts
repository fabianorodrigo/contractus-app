...
> {
  ...
  constructor(
    ...
    protected entregavelTipoOrdemServicoRepositoryGetter: Getter<
      EntregavelTipoOrdemServicoRepository
    >,
    @repository.getter('IndicadorNiveisServicoContratoRepository')
    protected indicadorNiveisServicoContratoRepositoryGetter: Getter<
      IndicadorNiveisServicoContratoRepository
    >,
  ) {
