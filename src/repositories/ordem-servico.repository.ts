...
export class OrdemServicoRepository extends DefaultCrudRepository<
  ...
  OrdemServicoRelations
> {
  public readonly itens: HasManyRepositoryFactory<
    ItemOrdemServico,
    typeof OrdemServico.prototype.id
  >;
  ...
  constructor(
    ...
    this.indicadores = this.createHasManyRepositoryFactoryFor(
      'indicadores',
      indicadorOrdemServicoRepositoryGetter,
    );
    this.registerInclusionResolver(
      'indicadores',
      this.indicadores.inclusionResolver,
    );
    ...
    this.registerInclusionResolver(
      'entregaveis',
      this.entregaveis.inclusionResolver,
    );
    this.etapas = this.createHasManyRepositoryFactoryFor(
      'etapas',
      etapaOrdemServicoRepositoryGetter,
    );
    this.registerInclusionResolver('etapas', this.etapas.inclusionResolver);
    this.itens = this.createHasManyRepositoryFactoryFor(
      'itens',
      itemOrdemServicoRepositoryGetter,
    );
