...
export class ContratoRepository extends DefaultCrudRepository<
  ...
  ContratoRelations
> {
  public readonly fornecedor: BelongsToAccessor<
    Fornecedor,
    typeof Contrato.prototype.id
  >;

  public readonly papeis: HasManyRepositoryFactory<
    PapelContrato,
    typeof Contrato.prototype.id
  >;

  public readonly metricas: HasManyRepositoryFactory<
    MetricaContrato,
    typeof Contrato.prototype.id
  >;

  public readonly tiposOrdemServico: HasManyRepositoryFactory<
    TipoOrdemServicoContrato,
    typeof Contrato.prototype.id
  >;

  public readonly ordensServico: HasManyRepositoryFactory<
    OrdemServico,
    typeof Contrato.prototype.id
  >;
  ...
  constructor(
    ...
    protected metricaContratoRepositoryGetter: Getter<
      MetricaContratoRepository
    >,
    @repository.getter('TipoOrdemServicoContratoRepository')
    protected tipoOrdemServicoContratoRepositoryGetter: Getter<
      TipoOrdemServicoContratoRepository
    >,
    ...
    this.ordensServico = this.createHasManyRepositoryFactoryFor(
      'ordensServico',
      ordemServicoRepositoryGetter,
    );
    this.registerInclusionResolver(
      'ordensServico',
      this.ordensServico.inclusionResolver,
    );
    ...
    this.registerInclusionResolver(
      'tiposOrdemServico',
      this.tiposOrdemServico.inclusionResolver,
    );
    this.metricas = this.createHasManyRepositoryFactoryFor(
      'metricas',
      metricaContratoRepositoryGetter,
    );
    this.registerInclusionResolver('metricas', this.metricas.inclusionResolver);
    this.papeis = this.createHasManyRepositoryFactoryFor(
      'papeis',
      papelContratoRepositoryGetter,
    );
    this.registerInclusionResolver('papeis', this.papeis.inclusionResolver);
    this.fornecedor = this.createBelongsToAccessorFor(
      'fornecedor',
      fornecedorRepositoryGetter,
    );
    this.registerInclusionResolver(
      'fornecedor',
      this.fornecedor.inclusionResolver,
    );
  }
}
