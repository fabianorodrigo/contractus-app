...
import {EntregavelTipoOrdemServico, TipoOrdemServicoContrato} from '../models';
...
export class TipoOrdemServicoContratoEntregavelTipoOrdemServicoController {
    ...
    @get('/tipo-ordem-servico-contratoes/{id}/entregavel-tipo-ordem-servicos', {
        responses: {
            '200': {
                description: 'Array of TipoOrdemServicoContrato has many EntregavelTipoOrdemServico',
                content: {
                    'application/json': {
                        schema: {
                            type: 'array',
    ...
    async create(
        ...
        return this.tipoOrdemServicoContratoRepository.entregaveis(id).create(entregavelTipoOrdemServico);
    }

    @patch('/tipo-ordem-servico-contratoes/{id}/entregavel-tipo-ordem-servicos', {
        responses: {
            '200': {
                description: 'TipoOrdemServicoContrato.EntregavelTipoOrdemServico PATCH success count',
    ...
    async patch(
        ...
        return this.tipoOrdemServicoContratoRepository.entregaveis(id).patch(entregavelTipoOrdemServico, where);
    }

    @del('/tipo-ordem-servico-contratoes/{id}/entregavel-tipo-ordem-servicos', {
        responses: {
            '200': {
                description: 'TipoOrdemServicoContrato.EntregavelTipoOrdemServico DELETE success count',
                content: {'application/json': {schema: CountSchema}},
            },
        },
    })
    async delete(
        ...
        return this.tipoOrdemServicoContratoRepository.entregaveis(id).delete(where);
    }
}
