...
export class IndicadorNiveisServicoContratoController {
    ...
    async create(
        ...
        return this.indicadorNiveisServicoContratoRepository.create(indicadorNiveisServicoContrato);
    }
    ...
    async updateAll(
        ...
        return this.indicadorNiveisServicoContratoRepository.updateAll(indicadorNiveisServicoContrato, where);
    }
    ...
    async updateById(
        ...
        await this.indicadorNiveisServicoContratoRepository.updateById(id, indicadorNiveisServicoContrato);
    }
    ...
    async replaceById(
        ...
        await this.indicadorNiveisServicoContratoRepository.replaceById(id, indicadorNiveisServicoContrato);
    }
