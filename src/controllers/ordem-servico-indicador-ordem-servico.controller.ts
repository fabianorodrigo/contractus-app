...
import {IndicadorOrdemServico, OrdemServico} from '../models';
...
export class OrdemServicoIndicadorOrdemServicoController {
    ...
    async create(
        ...
        return this.ordemServicoRepository.indicadores(id).create(indicadorOrdemServico);
    }
    ...
    async patch(
        ...
        return this.ordemServicoRepository.indicadores(id).patch(indicadorOrdemServico, where);
    }
