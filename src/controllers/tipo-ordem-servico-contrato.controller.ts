...
export class TipoOrdemServicoContratoController {
    ...
    async create(
        ...
        return this.tipoOrdemServicoContratoRepository.create(tipoOrdemServicoContrato);
    }
    ...
    async updateAll(
        ...
        return this.tipoOrdemServicoContratoRepository.updateAll(tipoOrdemServicoContrato, where);
    }
    ...
    async updateById(
        ...
        await this.tipoOrdemServicoContratoRepository.updateById(id, tipoOrdemServicoContrato);
    }
    ...
    async replaceById(
        ...
        await this.tipoOrdemServicoContratoRepository.replaceById(id, tipoOrdemServicoContrato);
    }
