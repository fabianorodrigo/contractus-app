...
export class EntregavelTipoOrdemServicoController {
    ...
    async create(
        ...
        return this.entregavelTipoOrdemServicoRepository.create(entregavelTipoOrdemServico);
    }
    ...
    async updateAll(
        ...
        return this.entregavelTipoOrdemServicoRepository.updateAll(entregavelTipoOrdemServico, where);
    }
    ...
    async updateById(
        ...
        await this.entregavelTipoOrdemServicoRepository.updateById(id, entregavelTipoOrdemServico);
    }
    ...
    async replaceById(
        ...
        await this.entregavelTipoOrdemServicoRepository.replaceById(id, entregavelTipoOrdemServico);
    }
