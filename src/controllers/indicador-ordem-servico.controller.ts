...
export class IndicadorOrdemServicoController {
  ...
  async updateAll(
    ...
    return this.indicadorOrdemServicoRepository.updateAll(
  ...
  async updateById(
    ...
    await this.indicadorOrdemServicoRepository.updateById(
      id,
      indicadorOrdemServico,
    );
  }
  ...
  async replaceById(
    ...
    await this.indicadorOrdemServicoRepository.replaceById(
      id,
      indicadorOrdemServico,
    );
  }
