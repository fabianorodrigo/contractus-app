...
export class ContratoTipoOrdemServicoContratoController {
    ...
    async create(
        ...
        return this.contratoRepository.tiposOrdemServico(id).create(tipoOrdemServicoContrato);
    }
    ...
    async patch(
        ...
        return this.contratoRepository.tiposOrdemServico(id).patch(tipoOrdemServicoContrato, where);
    }
