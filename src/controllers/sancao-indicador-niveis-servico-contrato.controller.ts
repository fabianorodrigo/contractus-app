...
export class SancaoIndicadorNiveisServicoContratoController {
  ...
  async create(
    ...
    return this.sancaoIndicadorNiveisServicoContratoRepository.create(
      sancaoIndicadorNiveisServicoContrato,
    );
  }
  ...
  @get('/sancao-indicador-niveis-servico-contrato', {
    responses: {
      '200': {
        description:
          'Array of SancaoIndicadorNiveisServicoContrato model instances',
        content: {
          'application/json': {
            schema: {
              type: 'array',
  ...
  async findById(
    ...
    return this.sancaoIndicadorNiveisServicoContratoRepository.findById(
      id,
      filter,
    );
  }
  ...
  async updateById(
    ...
    await this.sancaoIndicadorNiveisServicoContratoRepository.updateById(
      id,
      sancaoIndicadorNiveisServicoContrato,
    );
  }
  ...
  async replaceById(
    ...
    await this.sancaoIndicadorNiveisServicoContratoRepository.replaceById(
      id,
      sancaoIndicadorNiveisServicoContrato,
    );
  }
