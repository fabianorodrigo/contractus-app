...
export class EntregavelOrdemServicoController {
    ...
    async count(@param.where(EntregavelOrdemServico) where?: Where<EntregavelOrdemServico>): Promise<Count> {
    ...
    async updateAll(
        ...
        return this.entregavelOrdemServicoRepository.updateAll(entregavelOrdemServico, where);
    }
    ...
    async updateById(
        ...
        await this.entregavelOrdemServicoRepository.updateById(id, entregavelOrdemServico);
    }
    ...
    async replaceById(
        ...
        await this.entregavelOrdemServicoRepository.replaceById(id, entregavelOrdemServico);
    }
