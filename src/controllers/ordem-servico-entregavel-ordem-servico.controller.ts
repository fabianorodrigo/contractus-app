...
import {EntregavelOrdemServico, OrdemServico} from '../models';
...
export class OrdemServicoEntregavelOrdemServicoController {
    ...
    async create(
        ...
        return this.ordemServicoRepository.entregaveis(id).create(entregavelOrdemServico);
    }
    ...
    async patch(
        ...
        return this.ordemServicoRepository.entregaveis(id).patch(entregavelOrdemServico, where);
    }
