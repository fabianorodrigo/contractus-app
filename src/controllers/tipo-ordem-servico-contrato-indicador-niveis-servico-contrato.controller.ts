...
export class TipoOrdemServicoContratoIndicadorNiveisServicoContratoController {
  ...
  @get(
    '/tipo-ordem-servico-contratoes/{id}/indicador-niveis-servico-contratoes',
    {
      responses: {
        '200': {
          description:
            'Array of TipoOrdemServicoContrato has many IndicadorNiveisServicoContrato',
          content: {
            'application/json': {
              schema: {
                type: 'array',
  ...
  async create(
    ...
    @requestBody({
      content: {
        'application/json': {
          schema: getModelSchemaRef(IndicadorNiveisServicoContrato, {
            title:
              'NewIndicadorNiveisServicoContratoInTipoOrdemServicoContrato',
            exclude: ['id'],
    ...
    return this.tipoOrdemServicoContratoRepository
      .indicadores(id)
      .create(indicadorNiveisServicoContrato);
  }
  ...
  @patch(
    '/tipo-ordem-servico-contratoes/{id}/indicador-niveis-servico-contratoes',
    {
      responses: {
        '200': {
          description:
            'TipoOrdemServicoContrato.IndicadorNiveisServicoContrato PATCH success count',
  ...
  async patch(
    ...
    @param.query.object(
      'where',
      getWhereSchemaFor(IndicadorNiveisServicoContrato),
    )
    where?: Where<IndicadorNiveisServicoContrato>,
  ): Promise<Count> {
    return this.tipoOrdemServicoContratoRepository
      .indicadores(id)
      .patch(indicadorNiveisServicoContrato, where);
  }
  ...
  @del(
    '/tipo-ordem-servico-contratoes/{id}/indicador-niveis-servico-contratoes',
    {
      responses: {
        '200': {
          description:
            'TipoOrdemServicoContrato.IndicadorNiveisServicoContrato DELETE success count',
          content: {'application/json': {schema: CountSchema}},
        },
      },
    },
