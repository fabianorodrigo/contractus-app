...
export class IndicadorNiveisServicoContratoSancaoIndicadorNiveisServicoContratoController {
  ...
  @get(
    '/indicador-niveis-servico-contratoes/{id}/sancao-indicador-niveis-servico-contratoes',
    {
      responses: {
        '200': {
          description:
            'Array of IndicadorNiveisServicoContrato has many SancaoIndicadorNiveisServicoContrato',
          content: {
            'application/json': {
              schema: {
                type: 'array',
  ...
  async create(
    ...
    @requestBody({
      content: {
        'application/json': {
          schema: getModelSchemaRef(SancaoIndicadorNiveisServicoContrato, {
            title:
              'NewSancaoIndicadorNiveisServicoContratoInIndicadorNiveisServicoContrato',
            exclude: ['id'],
    ...
    sancaoIndicadorNiveisServicoContrato: Omit<
      SancaoIndicadorNiveisServicoContrato,
      'id'
    >,
  ): Promise<SancaoIndicadorNiveisServicoContrato> {
    return this.indicadorNiveisServicoContratoRepository
      .sancoes(id)
      .create(sancaoIndicadorNiveisServicoContrato);
  }
  ...
  @patch(
    '/indicador-niveis-servico-contratoes/{id}/sancao-indicador-niveis-servico-contratoes',
    {
      responses: {
        '200': {
          description:
            'IndicadorNiveisServicoContrato.SancaoIndicadorNiveisServicoContrato PATCH success count',
  ...
  async patch(
    ...
    sancaoIndicadorNiveisServicoContrato: Partial<
      SancaoIndicadorNiveisServicoContrato
    >,
    @param.query.object(
      'where',
      getWhereSchemaFor(SancaoIndicadorNiveisServicoContrato),
    )
  ...
  @del(
    '/indicador-niveis-servico-contratoes/{id}/sancao-indicador-niveis-servico-contratoes',
    {
      responses: {
        '200': {
          description:
            'IndicadorNiveisServicoContrato.SancaoIndicadorNiveisServicoContrato DELETE success count',
          content: {'application/json': {schema: CountSchema}},
        },
      },
    },
