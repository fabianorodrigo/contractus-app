...
export class RecebimentoOrdemServicoEntregavelRecebimentoOrdemServicoController {
  constructor(
    @repository(RecebimentoOrdemServicoRepository) protected recebimentoOrdemServicoRepository: RecebimentoOrdemServicoRepository,
  ) { }
  ...
  async patch(
    ...
    @param.query.object('where', getWhereSchemaFor(EntregavelRecebimentoOrdemServico)) where?: Where<EntregavelRecebimentoOrdemServico>,
  ): Promise<Count> {
