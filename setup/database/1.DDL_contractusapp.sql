...
CREATE TABLE contractusapp."TB_TIPO_ORDEM_SERVICO_CONTRATO" (
    ...
    "NR_DIAS_EMISSAO_TRD" integer NOT NULL
);
...
ALTER TABLE ONLY contractusapp."TB_TIPO_ORDEM_SERVICO_CONTRATO"
    ADD CONSTRAINT "FK_TIPO_ORDEM_SERVICO_CONTRATO" FOREIGN KEY("ID_CONTRATO") REFERENCES contractusapp."TB_CONTRATO"("ID_CONTRATO");
...
CREATE SEQUENCE contractusapp."SQ_TB_ENTREGAVEL_ORDEM_SERVICO"
    ...
    NO MAXVALUE
    CACHE 1;
ALTER TABLE contractusapp."SQ_TB_ENTREGAVEL_ORDEM_SERVICO" OWNER TO contractusapp;
ALTER SEQUENCE contractusapp."SQ_TB_ENTREGAVEL_ORDEM_SERVICO" OWNED BY contractusapp."TB_ENTREGAVEL_ORDEM_SERVICO"."ID_ENTREGAVEL_ORDEM_SERVICO";

ALTER TABLE ONLY contractusapp."TB_ENTREGAVEL_ORDEM_SERVICO" ALTER COLUMN "ID_ENTREGAVEL_ORDEM_SERVICO" SET DEFAULT nextval('contractusapp."SQ_TB_ENTREGAVEL_ORDEM_SERVICO"'::regclass);
...
--
-- Name: SQ_TB_ENTREGAVEL_ORDEM_SERVICO; Type: SEQUENCE SET; Schema: contractusapp; Owner: postgres
--
